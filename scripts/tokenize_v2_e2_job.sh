...
#SBATCH --mem=24G
#SBATCH --job-name=build_v2_e2
#SBATCH --output=/scratch/%u/tinylm/logs/build_v2_e2_%j.log
#
# Build the v2 Run E2 broader-mixture shards (21 x 100M = 2.1B tokens):
# 55% FineWeb-Edu / 20% general web / 15% code / 10% math, document-interleaved.
...
#
# Submit with:
#   sbatch ~/TinyLM/scripts/tokenize_v2_e2_job.sh
set -euo pipefail
